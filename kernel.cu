...
// вспомогательная функция при проверки корректности ввода
bool skipLine() {
	char c;
	bool isClear = true;
	do {
...
// проверка корректности введения ЧИСЛА
...
int main(int argc, char* argv[])
{
	...
	while (!readDoubleInt(N) || N == 0 || (int)N % 16 != 0)	// проверка корректного чтения размерности массива
	{
		printf("Похоже Вы неверно ввели размерность массива. Пожалуйста повторите ввод.\n");
	}
